...
@Component({
  ...
  styleUrl: './product-collection-list.component.scss'
})
export class ProductCollectionListComponent {
  collection: any;
  ...
  getProductList(id){
    ...
    this.productService.getCollectionProductList(param).subscribe(res => {
