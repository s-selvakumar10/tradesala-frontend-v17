...
@Component({
  selector: 'lib-img-zoom',
  templateUrl: './image-zoom.component.html',
  styleUrls: ['./image-zoom.component.scss'],
})
export class ImgZoomComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private zoomService: ImgZoomService
    ) {
      this.zoomBreakPoints = this.zoomService.zoomBreakPoints;
    }

    zoomMode: ImgZoomMode = this.zoomService.zoomMode;
  ...
  @HostListener('window:click', ['$event.target']) onclick(event) {
   ...
   @HostListener('mouseover', ['$event']) mouseWheelUp(e) {   
    ...
    @HostListener('mouseout', ['$event']) mouseWheelDown(e) {
      let element = e.target.id;
      if(element !== 'myimage'){ 
