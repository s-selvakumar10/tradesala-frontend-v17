import { OnInit, ElementRef, Input, Directive, Inject, HostListener, Renderer2, Injectable } from '@angular/core';
    ...
    if (this._topMarker && this._bottomMarker && enabled && isMobile) {
      ...
      if (y > startPosition) {
        ...
        if (y > stopPosition) {
          ...
          //  }
          this._renderer.setStyle(this._element.nativeElement, 'top', 100 +'px');
        }
